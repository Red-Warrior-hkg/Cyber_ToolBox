...
\*\*Task Manager clone\*\* is a lightweight Task Manager clone that runs directly in your terminal, providing real-time monitoring of all active system processes and overall memory usage.
...
git clone https://github.com/Red-Warrior-hkg/Cyber\\\_ToolBox.git

cd taskmanager-clone
